	...
	<div class="content-wrapper">
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0 text-dark">Cliente número {{String(cliente.id).padStart(6, '000000')}}</h1>
					</div>
					<div class="col-sm-6">
		...
		<section class="content">
			<div class="container-fluid">
				<div class="bs-callout bs-callout-success" v-show="updated">
					<h4>Cliente actualizado</h4>
					<p>
						El cliente con identificación
						<span class="font-weight-bold">
							C-{{String(cliente.id).padStart(6, '000000')}}
						</span> fue actualizado correctamente
					</p>
				</div>
				<div class="bs-callout bs-callout-danger" v-show="total_contadores == 0">
					<h4>No hay ningún contador</h4>
				</div>
				<div class="row">
					<div class="col-md-3">
						...
						<div class="card">
							<div class="card-header p-2">
								<ul class="nav nav-pills">
									<li class="nav-item">
										<a class="nav-link active" href="#datos_personales" data-toggle="tab">
											<i class="fas fa-user fa-lg mr-2"></i>
											Datos personales
										</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#contadores" data-toggle="tab">
											<i class="fas fa-stopwatch-20 fa-lg mr-2"></i>
											Contadores
										</a>
									</li>
								</ul>
							...
							<div class="card-body">
								<div class="tab-content">
									<div class="active tab-pane" id="datos_personales">
										<form autocomplete="off" class="form-horizontal" v-on:submit.prevent="updateCliente" data-vv-scope="cliente">
		...
		methods: {
			updateCliente() {
				...
				.then(isValid => {
					if(isValid) {
						this.errors_server = [];
						axios.put('/api/clientes/' + this.cliente.id, this.cliente)
						.then(response => {
							this.cliente = response.data
							Swal.fire({
								title: 'Registro actualizado',
								html: 'El cliente fue actualizado correctamente',
								icon: 'success'
							})
							.then(result => {
								this.updated = true
